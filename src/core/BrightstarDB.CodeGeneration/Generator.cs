...
";
            ...
            Func<INamedTypeSymbol, bool> interfacePredicate = null)
        {
            ...
            context = context.WithLeadingTrivia(
                language == Language.CSharp
                    ? SyntaxFactory.ParseLeadingTrivia(headerComment)
                    : VB.SyntaxFactory.ParseLeadingTrivia(headerComment));

            return new[] { context }
                .Concat(entities)
                .Select(x => Formatter.Format(x, workspace))
                .ToImmutableList();
        }
        ...
        private abstract class GeneratorBase
        {
            ...
            protected SyntaxNode GetTypeOf(SyntaxNode type)
            {
                // inexplicably, Roslyn's SyntaxGenerator does not support getting a typeof/GetType expression
                // may submit a PR
                switch (language)
                {
                    case Language.CSharp:
                                            ...
                                            syntaxGenerator
                                                .InvocationExpression(
                                                    ...
                                                    syntaxGenerator.MemberAccessExpression(
                                                        ...
                                                        "Instance"),
                                                    GetTypeOf(syntaxGenerator.TypeExpression(x))),
                                            syntaxGenerator
                                                .InvocationExpression(
                                                    syntaxGenerator.MemberAccessExpression(
                                                        syntaxGenerator.MemberAccessExpression(
                ...
                return syntaxGenerator.WithTypeConstraint(
                    syntaxGenerator.MethodDeclaration(
                        ...
                        statements:
                            new[]
                            {
                                syntaxGenerator.LocalDeclarationStatement(typeType, "type", GetTypeOf(syntaxGenerator.IdentifierName("T")))
                            }
                            .Concat(
                                interfaceSymbols
                                ...
                                syntaxGenerator.ThrowStatement(
                                    syntaxGenerator.ObjectCreationExpression(
                                        ...
                                        syntaxGenerator.AddExpression(
                                            syntaxGenerator.MemberAccessExpression(
                                                GetTypeOf(syntaxGenerator.IdentifierName("T")),
                                                "FullName"),
                ...
                yield return syntaxGenerator
                    .ConstructorDeclaration(
                        ...
                        baseConstructorArguments: new[]
                        {
                            ...
                            GetTypeOf(syntaxGenerator.IdentifierName(this.name))
                        });
